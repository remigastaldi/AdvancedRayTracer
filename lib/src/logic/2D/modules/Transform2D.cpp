...
Transform2D::Transform2D(Shape2D &parent, std::string id) : Entity{std::move(id)}, _x{0}, _y{0}, _width{0}, _height{0} {
...
void Transform2D::setX(double x) noexcept { _x = x; }
void Transform2D::setY(double y) noexcept { _y = y; }
void Transform2D::setWidth(double width) noexcept { _width = width; }
void Transform2D::setHeight(double height) noexcept { _height = height; }
